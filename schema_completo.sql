...
VALUES 
  ...
  (15, 'Plataforma Streaming Eventos', 'soporte@eventosstream.com', '+57 313 111 2233', 'Soporte Técnico de Alta Concurrencia', 'Requerimos acompañamiento DevOps para un evento en vivo de 50,000 personas.', NOW() - INTERVAL '4 days', false, 'REASIGNADA', 'Caso reasignado a Carlos Gómez por requerir conocimientos avanzados en infraestructura AWS y Docker.', NOW() - INTERVAL '2 days', NULL, NULL, 0, '[Hace 4 días] Atendido inicialmente por Roberto Silva\n[Hace 1 día] REASIGNADA a Carlos Gómez (Coordinador General) para dirección de infraestructura.', 1);
