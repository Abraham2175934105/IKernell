...
-- Versión: 4.0 Industrial Grade & High Concurrency Performance
-- ==============================================================================
...
-- Password genérico BCrypt para 'abrah1234': $2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG
INSERT INTO trabajador (id_trabajador, identificacion, nombre, apellido, fecha_nacimiento, direccion, profesion, especialidad, tipo_trabajador, foto_url, email, email_personal, rol, password_hash, estado) VALUES
-- Coordinadores (2)
...
(4, '1001004', 'Alejandro', 'Silva', '1986-06-15', 'Calle 100 # 19-40', 'Tech Lead & Arquitecto de Software', 'Arquitectura Distribuida & Java 17', 'PLANTA', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', 'alejandro.lider@ikernell.org', 'alejandro.silva.personal@gmail.com', 'LIDER', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(5, '1001005', 'Mariana', 'Torres', '1988-08-23', 'Calle 45 # 12-30', 'Ingeniera de Software & Scrum Master', 'Liderazgo de Proyectos & Metodologías Ágiles', 'PLANTA', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', 'mariana.lider@ikernell.org', 'mariana.torres.personal@gmail.com', 'LIDER', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(6, '1001006', 'David', 'López', '1987-11-19', 'Av. Boyacá # 72-15', 'Líder de Infraestructura & Cloud', 'AWS, DevOps & Seguridad Cloud', 'PLANTA', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150', 'david.lider@ikernell.org', 'david.lopez.personal@gmail.com', 'LIDER', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(7, '1001007', 'Sofía', 'Ramírez', '1990-05-14', 'Carrera 15 # 80-45', 'Líder de Innovación & Machine Learning', 'IA, Python & Data Science', 'PLANTA', 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150', 'sofia.lider@ikernell.org', 'sofia.ramirez.personal@gmail.com', 'LIDER', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(8, '1001008', 'Fernando', 'Castro', '1984-09-28', 'Av. Circunvalar 23-10', 'Líder de Sistemas de Información', 'ERP, SAP & Integraciones Enterprise', 'PLANTA', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', 'fernando.lider@ikernell.org', 'fernando.castro.personal@gmail.com', 'LIDER', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),

-- Desarrolladores (30)
(9, '1001009', 'Mateo', 'Morales', '1994-02-18', 'Av. Suba # 116-40', 'Desarrollador Frontend Senior', 'React 18, TypeScript & Tailwind CSS', 'PLANTA', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', 'mateo.dev@ikernell.org', 'mateo.morales@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(10, '1001010', 'Camila', 'Vargas', '1993-09-20', 'Carrera 7 # 116-50', 'Desarrolladora Backend Java', 'Spring Boot 3, Java 17 & Microservicios', 'PLANTA', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150', 'camila.dev@ikernell.org', 'camila.vargas@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(11, '1001011', 'Lucas', 'Herrera', '1991-04-03', 'Diagonal 45 # 22-80', 'Administrador de Base de Datos', 'PostgreSQL DBA & SQL Tuning', 'PLANTA', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150', 'lucas.dev@ikernell.org', 'lucas.herrera@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(12, '1001012', 'Isabella', 'Rojas', '1997-01-19', 'Calle 134 # 9-60', 'Ingeniera de Pruebas QA', 'QA Automation, JUnit & Mockito', 'PLANTA', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', 'isabella.dev@ikernell.org', 'isabella.rojas@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(13, '1001013', 'Gabriel', 'Benítez', '1994-07-22', 'Calle 80 # 11-45', 'Ingeniero DevOps', 'Docker, Kubernetes & CI/CD Pipelines', 'PLANTA', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150', 'gabriel.dev@ikernell.org', 'gabriel.benitez@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(14, '1001014', 'Valentina', 'Ortiz', '1996-10-30', 'Carrera 68 # 45-20', 'Diseñadora UI/UX', 'Figma Prototyping & Design Systems', 'PLANTA', 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150', 'valentina.dev@ikernell.org', 'valentina.ortiz@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(15, '1001015', 'Mateo', 'Silva', '1995-12-08', 'Carrera 45 # 28-10', 'Desarrollador Frontend', 'React.js & Next.js', 'CONTRATISTA', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', 'mateos.dev@ikernell.org', 'mateo.silva@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
...
(18, '1001018', 'Victoria', 'Rivas', '1995-04-18', 'Calle 100 # 23-10', 'Ingeniera de Datos', 'Python, ETL & PostgreSQL', 'PLANTA', 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150', 'victoria.dev@ikernell.org', 'victoria.rivas@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(19, '1001019', 'Daniel', 'Castillo', '1993-02-11', 'Calle 116 # 15-30', 'Ingeniero QA Automation', 'Cypress, Jest & Selenium', 'CONTRATISTA', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150', 'daniel.dev@ikernell.org', 'daniel.castillo@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(20, '1001020', 'Natalia', 'Domínguez', '1997-08-25', 'Carrera 19 # 104-15', 'Arquitecta Cloud Junior', 'AWS Cloud & Terraform', 'PLANTA', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150', 'natalia.dev@ikernell.org', 'natalia.dominguez@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(21, '1001021', 'Andrés', 'Vega', '1991-10-12', 'Calle 45 # 18-90', 'Desarrollador Backend Java', 'Spring Boot 3 & Redis Cache', 'PLANTA', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', 'andres.dev@ikernell.org', 'andres.vega@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(22, '1001022', 'Paola', 'Reyes', '1995-06-30', 'Carrera 9 # 120-40', 'Desarrolladora Frontend', 'React.js, Redux & Tailwind', 'PLANTA', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', 'paola.dev@ikernell.org', 'paola.reyes@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(23, '1001023', 'Esteban', 'Medina', '1990-01-15', 'Av. 68 # 80-10', 'Administrador de Base de Datos', 'PostgreSQL Tuning & Query Optimization', 'PLANTA', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150', 'esteban.dev@ikernell.org', 'esteban.medina@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(24, '1001024', 'Daniela', 'Paredes', '1996-09-14', 'Calle 100 # 55-20', 'Ingeniera QA de Seguridad', 'OWASP Testing & Pentesting Web', 'CONTRATISTA', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', 'daniela.dev@ikernell.org', 'daniela.paredes@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(25, '1001025', 'Felipe', 'Salazar', '1992-05-20', 'Transversal 15 # 40-10', 'Ingeniero DevOps CI/CD', 'GitHub Actions & Docker Containerization', 'PLANTA', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150', 'felipe.dev@ikernell.org', 'felipe.salazar@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(26, '1001026', 'Andrea', 'Cárdenas', '1994-12-05', 'Calle 127 # 20-30', 'Diseñadora de Producto UI/UX', 'System Design & Wireframing Figma', 'PLANTA', 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150', 'andrea.dev@ikernell.org', 'andrea.cardenas@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(27, '1001027', 'Javier', 'Peralta', '1993-04-18', 'Carrera 50 # 100-15', 'Desarrollador Full Stack', 'React.js & Spring Boot 3', 'PLANTA', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150', 'javierp.dev@ikernell.org', 'javier.peralta@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(28, '1001028', 'Monica', 'Ibáñez', '1995-11-28', 'Calle 85 # 12-40', 'Desarrolladora Backend Microservicios', 'Java 17, Spring Boot & Kafka', 'PLANTA', 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150', 'monica.dev@ikernell.org', 'monica.ibanez@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(29, '1001029', 'Rodrigo', 'Delgado', '1989-08-04', 'Av. El Dorado # 68-90', 'Administrador de Base de Datos', 'PostgreSQL Migration & Backup Strategies', 'PLANTA', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', 'rodrigo.dev@ikernell.org', 'rodrigo.delgado@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(30, '1001030', 'Claudia', 'Bravo', '1996-01-23', 'Carrera 11 # 93-20', 'Ingeniera QA Lead', 'Test Strategy & Automated Regression', 'PLANTA', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150', 'claudia.dev@ikernell.org', 'claudia.bravo@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(31, '1001031', 'Bruno', 'Miranda', '1992-03-30', 'Calle 140 # 11-15', 'Ingeniero DevOps Lead', 'Kubernetes Helm & Cloud Native Security', 'PLANTA', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150', 'bruno.dev@ikernell.org', 'bruno.miranda@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(32, '1001032', 'Valeria', 'Fuentes', '1997-07-11', 'Carrera 7 # 45-60', 'Desarrolladora Frontend Mobile', 'React Native & React.js', 'CONTRATISTA', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150', 'valeria.dev@ikernell.org', 'valeria.fuentes@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(33, '1001033', 'Ignacio', 'Rosas', '1994-05-09', 'Calle 72 # 20-50', 'Desarrollador Backend Senior', 'Go, Java 17 & Microservicios', 'PLANTA', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', 'ignacio.dev@ikernell.org', 'ignacio.rosas@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(34, '1001034', 'Gabriel', 'Villalobos', '1993-10-15', 'Av. 19 # 100-25', 'Desarrollador Full Stack', 'React.js, Python & FastAPI', 'PLANTA', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150', 'gabrielv.dev@ikernell.org', 'gabriel.villalobos@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(35, '1001035', 'Diana', 'Solís', '1996-06-18', 'Carrera 15 # 116-30', 'Ingeniera QA Manual & Usabilidad', 'Software QA & User Acceptance Testing', 'PLANTA', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', 'diana.dev@ikernell.org', 'diana.solis@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(36, '1001036', 'Hugo', 'Campos', '1991-09-02', 'Calle 100 # 18-50', 'Especialista en Ciberseguridad & DevOps', 'Cyber Security, Docker & Network Audit', 'PLANTA', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150', 'hugo.dev@ikernell.org', 'hugo.campos@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(37, '1001037', 'Beatriz', 'Peña', '1995-02-24', 'Carrera 9 # 100-10', 'Diseñadora UI/UX Lead', 'UI Prototyping & Design Systems', 'PLANTA', 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150', 'beatriz.dev@ikernell.org', 'beatriz.pena@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true),
(38, '1001038', 'Tomás', 'Guajardo', '1994-08-11', 'Calle 127 # 45-80', 'Desarrollador Backend', 'Node.js, Express & PostgreSQL', 'CONTRATISTA', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150', 'tomas.dev@ikernell.org', 'tomas.guajardo@gmail.com', 'DESARROLLADOR', '$2a$10$GVn/FMWL/swgoaRnJZ3HNe3RK/YMut0wHdZ9/Fd.ZhZ6Hu2J5bIhG', true);
...
-- Demostración de REGLA DE NEGOCIO DE DOBLE ROL:
-- Elena Rostova (Líder ID 3) es asignada como Desarrolladora en Proyecto 3 (dueño: Alejandro Silva ID 4).
-- Alejandro Silva (Líder ID 4) es asignado como Desarrollador en Proyecto 1 (dueño: Elena Rostova ID 3).
INSERT INTO proyecto_desarrollador (proyecto_id, desarrollador_id, horas_semanales) VALUES
-- Proyecto 1 (Líder Elena Rostova ID 3) -> Incluye Alejandro Silva (Líder ID 4 en rol dev)
(1, 4, 15),  -- Alejandro Silva (Líder) operando como Desarrollador
(1, 9, 40),  -- Mateo Morales
(1, 10, 40), -- Camila Vargas
(1, 14, 20), -- Valentina Ortiz

-- Proyecto 2 (Líder Elena Rostova ID 3)
(2, 9, 20),  -- Mateo Morales
(2, 11, 40), -- Lucas Herrera
(2, 12, 40), -- Isabella Rojas

-- Proyecto 3 (Líder Alejandro Silva ID 4) -> Incluye Elena Rostova (Líder ID 3 en rol dev)
(3, 3, 20),  -- Elena Rostova (Líder) operando como Desarrolladora
(3, 10, 20), -- Camila Vargas
(3, 13, 40), -- Gabriel Benítez
(3, 21, 40), -- Andrés Vega

-- Proyecto 4 (Líder Alejandro Silva ID 4)
(4, 15, 40), -- Mateo Silva
(4, 16, 40), -- Lucía Navarro
(4, 19, 20), -- Daniel Castillo

-- Proyecto 5 (Líder Mariana Torres ID 5)
(5, 17, 40), -- Santiago Flores
(5, 18, 40), -- Victoria Rivas
(5, 23, 40), -- Esteban Medina

-- Proyecto 6 (Líder Mariana Torres ID 5)
(6, 22, 40), -- Paola Reyes
(6, 24, 40), -- Daniela Paredes
(6, 26, 20), -- Andrea Cárdenas

-- Proyecto 7 (Líder David López ID 6)
(7, 25, 40), -- Felipe Salazar
(7, 27, 40), -- Javier Peralta
(7, 28, 40), -- Monica Ibáñez

-- Proyecto 8 (Líder David López ID 6)
(8, 29, 40), -- Rodrigo Delgado
(8, 30, 40), -- Claudia Bravo
(8, 31, 40), -- Bruno Miranda

-- Proyecto 9 (Líder Sofía Ramírez ID 7)
(9, 32, 40), -- Valeria Fuentes
(9, 33, 40), -- Ignacio Rosas
(9, 34, 40), -- Gabriel Villalobos

-- Proyecto 10 (Líder Sofía Ramírez ID 7)
(10, 35, 40), -- Diana Solís
(10, 36, 40), -- Hugo Campos
(10, 37, 40), -- Beatriz Peña

-- Proyecto 11 (Líder Fernando Castro ID 8)
(11, 38, 40), -- Tomás Guajardo
(11, 9, 20),  -- Mateo Morales
(11, 10, 20), -- Camila Vargas

-- Proyecto 12 (Líder Fernando Castro ID 8)
(12, 11, 20), -- Lucas Herrera
(12, 13, 20), -- Gabriel Benítez
(12, 21, 20), -- Andrés Vega

-- Proyecto 13 (Líder Elena Rostova ID 3)
(13, 36, 20), -- Hugo Campos
(13, 24, 20), -- Daniela Paredes
(13, 31, 20), -- Bruno Miranda

-- Proyecto 14 (Líder Alejandro Silva ID 4)
(14, 15, 20), -- Mateo Silva
(14, 17, 20), -- Santiago Flores
(14, 27, 20), -- Javier Peralta

-- Proyecto 15 (Líder Mariana Torres ID 5)
(15, 18, 20), -- Victoria Rivas
(15, 25, 20), -- Felipe Salazar
(15, 34, 20); -- Gabriel Villalobos


-- 4.4 INYECCIÓN DE ETAPAS WBS (3 Fases Estructuradas por cada uno de los 15 Proyectos)
...
-- 4.5 INYECCIÓN DE ACTIVIDADES WBS (50+ Tareas asignadas a Desarrolladores y a Líderes en Doble Rol)
INSERT INTO actividad (id_actividad, etapa_id, desarrollador_id, descripcion, estado) VALUES
-- Proyecto 1 (Líder Elena Rostova, incluye Alejandro Silva ID 4 en doble rol dev)
...
(3, 2, 4, 'Implementar módulo de autenticación biométrica en Spring Boot', 'EN_PROCESO'), -- Asignada a Alejandro Silva (Líder ID 4)
...
-- Proyecto 3 (Líder Alejandro Silva, incluye Elena Rostova ID 3 en doble rol dev)
(10, 7, 13, 'Definir manifiestos Docker y Helm Charts para Microservicios', 'COMPLETADO'),
(11, 8, 3, 'Construir microservicio de saldos y movimientos en Java 17', 'EN_PROCESO'), -- Asignada a Elena Rostova (Líder ID 3)
...
-- 4.6 INYECCIÓN DE ERRORES E INCIDENCIAS (20+ Reportes distribuidos para semáforo ROJO, NARANJA, VERDE)
...
-- Errores en Proyecto 1 (Para elevar indicador a ROJO/NARANJA)
...
-- Errores en Proyecto 3 (Para elevar indicador a ROJO)
...
-- Errores en Proyectos 5, 7, 9 (Severidades Medias y Bajas)
...
-- Errores Adicionales (Severidad Baja y Media)
...
-- 4.7 INYECCIÓN DE INTERRUPCIONES Y CONTINGENCIAS (15+ Eventos con duraciones para cálculo de semáforo)
...
-- Contingencias en Proyecto 1 (Acumula 1,080 minutos = 18 horas -> Semáforo ROJO)
...
-- Contingencias en Proyecto 3 (Acumula 1,020 minutos = 17 horas -> Semáforo ROJO)
...
-- Contingencias en Proyecto 2 y 5 (Semáforo NARANJA)
...
-- Contingencias Menores (Semáforo VERDE en los demás proyectos)
