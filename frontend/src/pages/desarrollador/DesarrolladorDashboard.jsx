...
export const DesarrolladorDashboard = () => {
  ...
  const handleCambiarEstado = async (idActividad, nuevoEstado) => {
    try {
      ...
      toast.success(`¡Caso / Tarea #${idActividad} actualizada con éxito a estado "${labels[nuevoEstado] || nuevoEstado}"!`, { icon: '✅', duration: 5000 });
    } catch (err) {
  ...
  const handleReportarError = async (e) => {
    ...
    try {
      ...
      toast.success('¡Caso de Error Técnico registrado con éxito! Guardado en PostgreSQL.', { icon: '✅', duration: 5000 });
  ...
  const handleReportarInterrupcion = async (e) => {
    ...
    try {
      ...
      toast.success(`¡Caso de Contingencia (${interrupcionForm.duracionMinutos} min) registrado con éxito! Guardado en PostgreSQL.`, { icon: '✅', duration: 5000 });
