...
export const DesarrolladorDashboard = () => {
  ...
  const handleCambiarEstado = async (idActividad, nuevoEstado) => {
    try {
      ...
      toast.success(`Estado actualizado a "${labels[nuevoEstado] || nuevoEstado}" en PostgreSQL.`);
    } catch (err) {
  ...
  const handleReportarError = async (e) => {
    ...
    try {
      ...
      toast.success('Error técnico guardado en PostgreSQL. El Semáforo Predictivo fue actualizado.');
  ...
  const handleReportarInterrupcion = async (e) => {
    ...
    try {
      ...
      toast.success(`Contingencia de ${interrupcionForm.duracionMinutos} minutos guardada en PostgreSQL.`);
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <h3 className="font-bold text-zinc-900 dark:text-white text-sm leading-snug">
                      {cleanDescripcion}
                    </h3>
                  </div>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col justify-between hover:border-zinc-400 dark:hover:border-zinc-600 transition-all duration-200">
              <div>
                ...
                <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-2">Reportar Error Técnico (RF-22)</h3>
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col justify-between hover:border-zinc-400 dark:hover:border-zinc-600 transition-all duration-200">
              <div>
                ...
                <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-2">Registrar Interrupción / Tiempos Muertos (RF-23, RF-24)</h3>
                <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
